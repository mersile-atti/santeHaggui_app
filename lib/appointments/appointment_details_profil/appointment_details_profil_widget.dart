...
class AppointmentDetailsProfilWidget extends StatefulWidget {
  const AppointmentDetailsProfilWidget({
    super.key,
  ...
  @override
  _AppointmentDetailsProfilWidgetState createState() =>
      _AppointmentDetailsProfilWidgetState();
}

class _AppointmentDetailsProfilWidgetState
    extends State<AppointmentDetailsProfilWidget> {
  late AppointmentDetailsProfilModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AppointmentDetailsProfilModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<AppointmentsRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final appointmentDetailsProfilAppointmentsRecord = snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
          backgroundColor: FlutterFlowTheme.of(context).primaryBackground,
          appBar: AppBar(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Expanded(
                        child: Text(
                          appointmentDetailsProfilAppointmentsRecord
                              .appointmentType,
                ...
                Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      await appointmentDetailsProfilAppointmentsRecord.reference
                          .delete();
                      context.pop();
                    },
