...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    santehagguiAuthUserSubject.add(
      SantehagguiAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<SantehagguiAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  SantehagguiAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = SantehagguiAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    santehagguiAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
