...
import 'article_news_component_model.dart';
export 'article_news_component_model.dart';

class ArticleNewsComponentWidget extends StatefulWidget {
  const ArticleNewsComponentWidget({super.key});

  @override
  _ArticleNewsComponentWidgetState createState() =>
      _ArticleNewsComponentWidgetState();
}

class _ArticleNewsComponentWidgetState
    extends State<ArticleNewsComponentWidget> {
  late ArticleNewsComponentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ArticleNewsComponentModel());
