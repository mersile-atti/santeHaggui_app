...
import 'ediit_booking_model.dart';
export 'ediit_booking_model.dart';

class EdiitBookingWidget extends StatefulWidget {
  const EdiitBookingWidget({
    super.key,
  ...
  @override
  _EdiitBookingWidgetState createState() => _EdiitBookingWidgetState();
}

class _EdiitBookingWidgetState extends State<EdiitBookingWidget> {
  late EdiitBookingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EdiitBookingModel());
