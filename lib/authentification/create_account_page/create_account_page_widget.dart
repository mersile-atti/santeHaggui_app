...
class _CreateAccountPageWidgetState extends State<CreateAccountPageWidget> {
  ...
  void initState() {
    ...
    _model.enterYourNameController ??= TextEditingController();
    _model.enterYourNameFocusNode ??= FocusNode();

    _model.enterYourEmailController ??= TextEditingController();
                            ...
                            children: [
                                ...
                                children: [
                                  Expanded(
                                    child: Padding(
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.enterYourNameController,
                                        focusNode:
                                            _model.enterYourNameFocusNode,
                                        obscureText: false,
                                        ...
                                        validator: _model
                                            .enterYourNameControllerValidator
                                            .asValidator(context),
                                      ),
                                    ),
                                  ),
                              ...
                              Padding(
                                padding: const EdgeInsetsDirectional.fromSTEB(
                                    16.0, 10.0, 16.0, 0.0),
                                child: TextFormField(
                                  controller: _model.enterYourEmailController,
                                  ...
                                  validator: _model
                                      .enterYourEmailControllerValidator
                                      .asValidator(context),
                                ),
                              ),
                              Padding(
                                ...
                                child: TextFormField(
                                  controller:
                                      _model.enterYourPhoneNumberController,
                                  focusNode:
                                      _model.enterYourPhoneNumberFocusNode,
                                  obscureText: false,
                                  decoration: InputDecoration(
                                    labelStyle: FlutterFlowTheme.of(context)
                                        .labelMedium
