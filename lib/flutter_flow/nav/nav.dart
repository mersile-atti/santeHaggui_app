...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'AppointmentDetailsProfil',
          path: '/appointmentDetailsProfil',
          builder: (context, params) => AppointmentDetailsProfilWidget(
            appointmentDetails: params.getParam('appointmentDetails',
                ParamType.DocumentReference, false, ['appointments']),
          ),
        ),
        ...
        FFRoute(
          name: 'listPages',
          path: '/listPages',
          builder: (context, params) => const ListPagesWidget(),
        ),
        FFRoute(
          name: 'PhoneLoginPage',
          path: '/phoneLoginPage',
